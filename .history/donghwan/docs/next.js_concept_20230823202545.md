...
1. 클라이언트에서 보여줄때 서버에서는 만들어진 페이지르 준다 (사용자에게 의미있는 데이터를 보여주기 위한 정적인 사이트) - preRendering
...
1-2. No 데이터가 변경되는가?
1-2-1 Yes 얼마나 자주 변경되는가?

1-2-1-1 YES SSR or Hybrid(ISR|SSG+CSR)
1-2-1-2 NO ISR
1-2-2 No SSG (next에서 기본적으로 처리) - 데이터 없고 상태 없을시 -->
